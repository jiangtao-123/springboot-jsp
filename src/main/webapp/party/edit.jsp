            ...
            <div class="layui-card-body">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            <input type="text" disabled name="joinTime" id="joinTime"
                                   placeholder="请选择"
                                   class=" layui-input date-icon" autocomplete="off"
                                   lay-verType="tips" lay-verify="required"
                                   required/>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            <select name="nodeId" disabled lay-verType="tips"
                                    lay-verify="required"
                                    required>
...
//赋值开始
    var id = admin.getLayerData('#modelUserForm').user.id
    $.post("/party/getPartyById", {id: id},
        function (mUser) {
          ...
          if (mUser.picture != "") {
            ...
            //添加图片
            $('#demo2').append('<div><img id="photoImg" src="' + mUser.picture + '" alt="' + "photo"
                + ' " class="layui-upload-img"  " ></br><a id="deleteImageEdit" style="cursor:pointer;">删除图片</a></div>'
            );
            //删除图片
            $("#deleteImageEdit").click(function () {
              ...
              //delete files[index];
              //后台删除图片
              $.post("/party/deletePhoto", {id: id}, function (data) {
                if (data) {
